...
//	? Consultar saldo: revisaremos el valor monetario que tiene asignada la variable "saldo".
	...
	Definir  usu, contr, op Como Caracter
	Definir  saldo, peso Como Real
	Definir  bot, precio, precioT Como Entero
	...
	Mientras login == Falso Hacer
		...
		si usu == "Albus_D" Y contr == "caramelosDeLimon" Entonces
			login = Verdadero
		FinSi
	Fin Mientras
	...
	Repetir
		...
		Segun Minusculas(op) Hacer
			...
			De Otro Modo:
				Escribir " Ingreso una opción erronea"
		Fin Segun
	Hasta Que op == s
FinAlgoritmo
